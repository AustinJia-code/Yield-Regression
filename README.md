Repository for [CS363M Fall 2025 Kaggle Competition](https://www.kaggle.com/competitions/fall-2025-ml-course-project/leaderboard)
...
* Are models compared in a correct and reasonable way?
* Does the code correctly implement the machine learning techniques? 
...
* Is the code clean, commented, and easy to follow?
* Can someone else run the notebook from start to finish without errors?
